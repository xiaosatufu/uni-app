...
/***/ 62:
/*!*************************************************************************************************!*\
  !*** /Users/guoqiwen/Desktop/uni-app/遛娃点评/pages/login/login.vue?vue&type=template&id=b237504c& ***!
  \*************************************************************************************************/
...
/***/ 63:
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--16-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/guoqiwen/Desktop/uni-app/遛娃点评/pages/login/login.vue?vue&type=template&id=b237504c& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var components = {
  uVerificationCode: function() {
    return __webpack_require__.e(/*! import() | uview-ui/components/u-verification-code/u-verification-code */ "uview-ui/components/u-verification-code/u-verification-code").then(__webpack_require__.bind(null, /*! @/uview-ui/components/u-verification-code/u-verification-code.vue */ 360))
  }
}
var render = function() {
  var _vm = this
...

{
  ...
  (0, _vuex.mapMutations)(['login', 'saveUserInfo']), {
    ...
    userLogin: function userLogin() {var _this2 = this;
      uni.login({
        success: function success(res) {
          _this2.loginData.code = res.code;

          _this2.$api.authLogin(_this2.loginData).then(function (response) {
            console.log(response);
            if (response) {
              //把token存入store
              _this2.login(response);
              //同步数据
              _this2.handleAuthUserInfo();
            }
          }).catch(function (err) {
            console.log(err);
          });
    ...
    handleAuthUserInfo: function handleAuthUserInfo() {var _this3 = this;
      var submitData = {
        wxEncryptionUser: {
      ...
      this.$api.authUserInfo(submitData).then(function (response) {
        console.log(response);
        if (response) {

          _this3.saveUserInfo(response);
          // 跳转到首页
          uni.reLaunch({
            url: '../index/index' });
