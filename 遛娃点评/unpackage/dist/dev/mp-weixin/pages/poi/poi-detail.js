...
var _navMixin = _interopRequireDefault(__webpack_require__(/*! ../../mixins/nav-mixin.js */ 46));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var scenicSpot = function scenicSpot() {__webpack_require__.e(/*! require.ensure | components/scenic-spot */ "components/scenic-spot").then((function () {return resolve(__webpack_require__(/*! ../../components/scenic-spot.vue */ 285));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var playWay = function playWay() {__webpack_require__.e(/*! require.ensure | components/play-way */ "components/play-way").then((function () {return resolve(__webpack_require__(/*! ../../components/play-way.vue */ 292));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var switchItem = function switchItem() {__webpack_require__.e(/*! require.ensure | components/switch */ "components/switch").then((function () {return resolve(__webpack_require__(/*! ../../components/switch.vue */ 299));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var commentCard = function commentCard() {__webpack_require__.e(/*! require.ensure | components/comment-card */ "components/comment-card").then((function () {return resolve(__webpack_require__(/*! ../../components/comment-card.vue */ 306));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default =
{
  ...
  mounted: function mounted() {var _this = this;
    this.$api.poiAppDetail(this.id).then(function (res) {
      console.log(res);
      _this.data = res;
      var pictures = JSON.parse(JSON.stringify(_this.data.pictures));
